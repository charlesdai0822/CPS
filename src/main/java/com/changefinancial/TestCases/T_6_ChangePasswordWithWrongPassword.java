...
public class T_6_ChangePasswordWithWrongPassword extends BaseCase{
    ...
    public void changePassword(){
        ...
        AssertLocal.assertEquals(sp.getUpdateMessage(),"Your current password is incorrect. Please ensure you have entered it correctly.");
    }
}
